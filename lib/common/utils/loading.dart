...
class Loading {
  ...
  Loading() {
    EasyLoading.instance
      ...
      ..indicatorType = EasyLoadingIndicatorType.circle // 指示器类型
  ...
  static void showProgress(double progress, [String? text]) {
    EasyLoading.instance.userInteractions = true; // 屏蔽交互操作
    EasyLoading.showProgress(progress, status: text ?? 'Uploading...'.tr);
  }
